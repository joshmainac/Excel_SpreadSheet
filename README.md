...
```
cd existing_repo
git remote add origin https://gitlab.eecs.wsu.edu/jlong3/cpts321-hws.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.eecs.wsu.edu/jlong3/cpts321-hws/-/settings/integrations)
